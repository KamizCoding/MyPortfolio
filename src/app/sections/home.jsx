...
export default function HomePage() {
  return (
    <div className="flex flex-col items-center h-screen font-sans w-full bg-cover bg-center bg-no-repeat bg-[url('/images/homebg.png')]">
      <div>
        ...
        <div className="flex pt-20">
          <div className="flex flex-col pt-20 pl-40 space y-2">
            <p className="text-4xl font-bold pl-30">I'm a</p>
            ...
            <div className="flex flex-col pl-18 pt-9">
